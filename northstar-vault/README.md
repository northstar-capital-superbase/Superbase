...
- It is designed to work unchanged for a solo founder on day one and for a multi-team engineering org years later. Folders were chosen because each one earns its place — see [`00-Meta/Conventions.md`](00-Meta/Conventions.md) for the reasoning.
